...
write.table(listG,sep="\t",quote=FALSE,row.names = FALSE,col.names = FALSE,file="data/tidy/nickyCellbodyMGL.txt")

listG = c("Nickys nuclei enriched genes",nickysDatNuclei$X1)
write.table(listG,sep="\t",quote=FALSE,row.names = FALSE,col.names = FALSE,file="data/tidy/nickyNucleiMGL.txt")
```
...
# LOAD Zeisel2018
load("/Users/natske/OneDrive - Imperial College London/Single Cell Datasets/ConvertJuliensFormat2ctd/data/tidy/ctd_ZieselAllLevels.Rda")
...
ctdFilePath = sprintf("/Users/natske/OneDrive - Imperial College London/DendriticEnrichment/Data/%s",fileName)
...
zeisel2018_dist = prepare.specificity.comparison.across.datasets(ctdFilePath,keepCells,species="mouse",datasetName="Zeisel 2018",useCell="Microglia",sharedName="Microglia",datasetGroup="Cell")

# LOAD Saunders2018
load("/Users/natske/OneDrive - Imperial College London/Single Cell Datasets/ConvertJuliensFormat2ctd/data/tidy/ctd_SaundersWithLvl1.Rda")
...
saunders2018_dist = prepare.specificity.comparison.across.datasets(ctdFilePath,keepCells,species="mouse",datasetName="Saunders 2018",useCell="Microglia",sharedName="Microglia",datasetGroup="Cell")

# LOAD Blue Lake 2018
load("/Users/natske/OneDrive - Imperial College London/Single Cell Datasets/BlueLake2018/CellTypeData_BlueLake2018_FrontalCortexOnly.rda")
celltype_data = EWCE::convert_new_ewce_to_old(ctd,1)
...
lakeFrontal_dist = prepare.specificity.comparison.across.datasets(ctdFilePath,keepCells,species="human",datasetName="Lake Frontal",useCell="Mic",sharedName="Microglia",datasetGroup="Nuclei")

# LOAD Blue Lake 2018
load("/Users/natske/OneDrive - Imperial College London/Single Cell Datasets/BlueLake2018/CellTypeData_BlueLake2018_VisualCortexOnly.rda")
celltype_data = EWCE::convert_new_ewce_to_old(ctd,1)
fileName = "celltype_data_BlueLakeVisualCortexOnly_level1.rda"
save(celltype_data,file=sprintf("Data/%s",fileName))
ctdFilePath = sprintf("/Users/natske/OneDrive - Imperial College London/DendriticEnrichment/Data/%s",fileName)
keepCells = c("Ast","Ex","In","Mic","OPC","Oli")
lakeVisual_dist = prepare.specificity.comparison.across.datasets(ctdFilePath,keepCells,species="human",datasetName="Lake Visual",useCell="Mic",sharedName="Microglia",datasetGroup="Nuclei")
...
for(listN in c("nickyCellbodyMGL","nickyNucleiMGL")){
    ...
    thePlot = generate_publication_plot_for_single_list(res,listName=listN)
}
```
